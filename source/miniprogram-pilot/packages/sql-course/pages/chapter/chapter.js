...
Page({
  ...
  openLesson: function (event) {
    ...
    if (!lessonId) return;
    var target = '/' + PACKAGE_ROOT + '/pages/lesson/lesson?chapterId=' + this.data.chapterId + '&sectionId=' + lessonId;
    wx.navigateTo({ url: target });
  },
  goBack: function () {
    secondaryNav.back(this, PACKAGE_ROOT + '/pages/chapter/chapter', { type: 'navigateTo', url: '/packages/sql-course/pages/home/home' });
  },
